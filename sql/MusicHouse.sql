...
CREATE OR REPLACE FUNCTION inserir_cliente(
    ...
    senha_cliente VARCHAR(255),  -- Adicionando a senha como parâmetro
...
BEGIN
    ...
    VALUES (nome_cliente, email_cliente, senha_cliente, data_cadastro_cliente)
...
BEGIN
    ...
    SELECT senha INTO cliente_senha FROM Clientes WHERE id = cliente_id;
    IF senha_cliente <> cliente_senha THEN
        RAISE EXCEPTION 'Senha incorreta para o cliente %', cliente_id;
    END IF;
...
INSERT INTO Clientes (nome, email, senha, data_cadastro)
VALUES ('Pedro Fratassi', 'pedro3fratassi@gmail.com', 'sua_senha_aqui', '2022-06-06'),
       ('Gisele Souza', 'gisele_sousa@gmail.com', 'outra_senha', '2022-05-15'),
       ('Keroly Andrade', 'kerolyandrade@gmail.com', 'mais_uma_senha', '2022-03-27');
